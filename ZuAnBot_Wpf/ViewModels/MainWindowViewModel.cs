    ...
    public class MainWindowViewModel : BindableBase
    {
        ...
        private void Hook_KeyUp(object sender, KeyEventArgs e)
        {
            try
            {
                ...
                int NextDelay() => _random.Next(100, 601);
                ...
                if (IsPerWord)
                {
                    ...
                    {
                        builder = builder.
                            Click(WindowsInput.Events.KeyCode.Enter).Wait(NextDelay()).
                            Click(allPre + item).Wait(NextDelay()).
                            Click(WindowsInput.Events.KeyCode.Enter).Wait(NextDelay());
                ...
                else
                {
                    builder = builder.
                        Click(WindowsInput.Events.KeyCode.Enter).Wait(NextDelay()).
                        Click(allPre + word).Wait(NextDelay()).
                        Click(WindowsInput.Events.KeyCode.Enter).Wait(NextDelay());
                }
                builder.Invoke();
            }
